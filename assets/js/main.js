window.onload=function(){
    ...
    // document.getElementById("izborFilter").addEventListener("change", filtriraj);
    
    $(".sakrij").hide();
    $(".sakrij").css("position", "absolute");
    $.ajax({
...
function ispisGradova(gradovi){
   ...
   // $(".srce2").on("click", dodajUOmiljene);
    $(".srce2").click(dodajUOmiljene);
    // document.getElementsByClassName("srce2").addEventListener("click", dodajUOmiljene);
}
